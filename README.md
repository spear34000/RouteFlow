...
[![Release](https://img.shields.io/badge/Release-v0.1.1-F6C7B8?color=DB5C34)](./docs/releases/v0.1.1.md)
...
MySQL, MongoDB, Redis, Elasticsearch, OpenSearch, DynamoDB, Snowflake도 같은 방식으로 `@spear340000/*` 패키지를 추가하면 됩니다.
